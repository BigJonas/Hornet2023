...
public class SwerveModule extends SubsystemBase {
  ...
  public void drive(SwerveModuleState state) {    
    ...
    SmartDashboard.putNumber("Wheel Circumference", WHEEL_CIRCUMFERENCE);
    SmartDashboard.putNumber("Speed CPR", TALON_ENCODER_CPR);
    SmartDashboard.putNumber("Gear Ratio", DRIVE_GEAR_RATIOS[getCurrentGear()]);
    SmartDashboard.putNumber("Meters Per Count", getMetersPerCount());
  ...
  public SwerveModulePosition getMeasuredPosition() {
    return new SwerveModulePosition(
      WHEEL_CIRCUMFERENCE, 
      new Rotation2d(nativeToRadians(getAngle()))
    );
  }
