...
public class SwerveDrive extends SubsystemBase {
  ...
  public SwerveDrive() {
    ...
    odometry = new SwerveDriveOdometry(swerveDriveKinematics, new Rotation2d(getGyroAngle()), getModulePositions());
  }
  ...
  public void drive(double xVelocity, double yVelocity, double angularVelocity) {    
    ...
    SmartDashboard.putNumber("Speed", moduleStates[0].speedMetersPerSecond);
    drive(moduleStates);
  }
