    ...
    mSwerveDrive.setDefaultCommand(
      new RunCommand(
        () -> {
          ...
          double str = m_driverController.getLeftX();
          ...
          mSwerveDrive.drive(fwd, str, rot);


          if (m_driverController.getLeftTriggerAxis() != 0.0) {
            mSwerveDrive.shiftDown();
          } else if (m_driverController.getRightTriggerAxis() != 0.0) {
            mSwerveDrive.shiftUp();
          }
        },
        mSwerveDrive
      )
